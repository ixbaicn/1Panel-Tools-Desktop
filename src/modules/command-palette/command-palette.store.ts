...
export const useCommandPaletteStore = defineStore('command-palette', () => {
  ...
  const searchOptions: PaletteOption[] = [
    ...
    },
    {
      ...
      category: 'External',
      description: 'View the source code of 1Panel Tools Desktop on GitHub.',
      keywords: ['github', 'repo', 'repository', 'source', 'code'],
      icon: GithubIcon,
    },
    {
      name: 'Report a bug or an issue',
      description: 'Report a bug or issue for 1Panel Tools Desktop.',
      href: 'https://github.com/ixbaicn/1Panel-Tools-Desktop/issues/new/choose',
      category: 'Actions',
    ...
    {
      name: 'About',
      description: 'Learn more about 1Panel Tools Desktop.',
      to: '/about',
      category: 'Pages',
